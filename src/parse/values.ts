...
export function toString(code: string): string {
	return `[]+(${code})`;
}

export function getConstructorFrom(
	val: string,
...
export function getStringConstructor(options: ResolvedOptions): string {
	return factory(
		"str_cons",
		getConstructorFrom(getString(options), options),
		options
	);
}
...
export function getRegexConstructorString(options: ResolvedOptions): string {
	return factory("regex_str", toString(getRegexConstructor(options)), options);
}

export function getStringConstructorString(options: ResolvedOptions): string {
	return factory(
		"str_cons_str",
		toString(getStringConstructor(options)),
		options
	);
}

export function getArrayConstructorString(options: ResolvedOptions): string {
	return factory("arr_str", toString(getArrayConstructor(options)), options);
}
